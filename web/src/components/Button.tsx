...
export function Button({
  ...
  return (
    <div
      className={twMerge(
        `items-center justify-center rounded-sm ${getBackground(type, isDisabled)}`,
        backgroundClasses,
        shouldShrink ? 'w-fit' : ''
      )}
    >
      <As
        className={twMerge(
          `flex h-full w-full select-none flex-row items-center justify-center rounded-sm text-sm font-semibold
